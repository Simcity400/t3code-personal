            ...
            contentEditable={
              <ContentEditable
                className={cn(
                  ...
                  "block max-h-[min(20rem,40dvh)] min-h-17.5 w-full overflow-y-auto whitespace-pre-wrap wrap-break-word bg-transparent leading-relaxed text-foreground focus:outline-none",
                  className,
                )}
