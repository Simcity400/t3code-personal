    ...
    >
      ...
      <span className="col-start-3 row-start-1 min-w-14 text-right font-mono text-[.7rem] text-muted-foreground/80">
        <span className="inline-flex items-center gap-1">
          ...
          {openTranscript ? <ChevronRight aria-hidden className="size-3" /> : null}
        </span>
      </span>
      <span
        className={cn(
...
export function AgentsPanel({
  ...
  return (
    <AgentTranscriptNavigation value={renderTranscript ? setSelectedAgent : null}>
      ...
      {selectedAgent && renderTranscript ? (
        <div className="flex h-full min-h-0 flex-col">
          <div className="flex items-center gap-2 border-b border-border/60 px-2 py-1.5">
            <Button variant="ghost-muted" size="sm" onClick={() => setSelectedAgent(null)}>
