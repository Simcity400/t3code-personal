...
// Fork note: raised from 1 minute — cold backend starts on this machine take
// ~90s, and the main window only opens once readiness succeeds.
const DEFAULT_BACKEND_READINESS_TIMEOUT = Duration.minutes(5);
