...
function isAgentInternalActivity(activity: OrchestrationThreadActivity): boolean {
  ...
  // A terminal bypassed row still reaches the ownership check below: an
  // unowned batch row shown in the feed needs its own terminal update to
  // settle, or it would report progress forever.
