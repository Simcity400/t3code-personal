/**
 * Context-window snapshots derived from persisted thread activities.
 *
 * Shared by every client surface: web renders the meter, mobile renders a
 * compact form of it, and both must agree on what a conversation's occupancy
 * is and whose it is.
 */
